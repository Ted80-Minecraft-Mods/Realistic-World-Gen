...
public class RealisticBiomeDunesForest extends RealisticBiomeBase
{
	private TerrainBase terrain;
	private SurfaceBase surface;

	public RealisticBiomeDunesForest() 
	{
    ...
    public void rDecorate(World world, Random rand, int chunkX, int chunkY, PerlinNoise perlin, CellNoise cell, float strength, float river)
    {
		...
		for(int b33 = 0; b33 < 3f * strength; b33++)
		{
			...
			if(z52 < 82)
			{
				WorldGenerator worldgenerator = rand.nextInt(8) != 0 ? new WorldGenShrub(0, 0) : new DecoSavannah(1);
				worldgenerator.setScale(1.0D, 1.0D, 1.0D);
				worldgenerator.generate(world, rand, j6, z52, k10);
			}
		}
