...
public class RealisticBiomeRedOasis extends RealisticBiomeBase {
    ...
    public RealisticBiomeRedOasis() {
        ...
        surface = new SurfaceDesertOasis(
                Blocks.grass, Blocks.dirt, Blocks.stained_hardened_clay, Blocks.stained_hardened_clay, (byte) 1, 1);
        ...
        for (int b33 = 0; b33 < 3f * strength; b33++) {
            ...
            if (z52 < 100f || (z52 < 120f && rand.nextInt(10) == 0)) {
                WorldGenerator worldgenerator =
                        rand.nextInt(4) != 0 ? new WorldGenShrub(0, 0) : new DecoSavannah(1, false);
