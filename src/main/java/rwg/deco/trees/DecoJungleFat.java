...
public class DecoJungleFat extends WorldGenerator
{
	...
	public DecoJungleFat(Block log, int metaLog, Block leaves, int metaLeaves, int baseHeight, int rootHeight, float branchLength,  int numBranches, float verticalStart, float verticalRand)
	{
		blockLog = log;
		metadataLog = metaLog;
		blockLeaves = leaves;
